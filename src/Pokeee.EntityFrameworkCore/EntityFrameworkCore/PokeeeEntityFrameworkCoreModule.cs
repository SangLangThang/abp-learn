...
namespace Pokeee.EntityFrameworkCore
{
    ...
    public class PokeeeEntityFrameworkCoreModule : AbpModule
    {
        ...
        {
            context.Services.AddAbpDbContext<PokeeeDbContext>(options =>
            {
                /* Remove "includeAllEntities: true" to create
                 * default repositories only for aggregate roots */
                options.AddDefaultRepositories(includeAllEntities: true);
                options.AddRepository<Pokemon, Pokemons.EfCorePokemonRepository>();

                options.AddRepository<Trainer, Trainers.EfCoreTrainerRepository>();
            ...
            Configure<AbpDbContextOptions>(options =>
            {
                 ...
                 * See also PokeeeDbContextFactory for EF Core tooling. */
